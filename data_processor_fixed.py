...
# -*- coding: utf-8 -*-
"""
Processador Avançado de Dados de Dengue - Versão Corrigida
"""
...
class DengueAdvancedProcessor:
    ...
    def _convert_data_types(self):
        ...
        # Converter idade para formato padrão
        # Baseado na análise, parece que os valores estão codificados:
        # - Valores < 1000: idade em anos
        # - Valores >= 1000: codificação especial
        self._convert_age()
    ...
    def _convert_age(self):
        """
        Converte a idade do formato codificado para idade em anos
        """
        print("Convertendo idades...")
        
        # Criar uma nova coluna para idade em anos
        self.df['IDADE_ANOS'] = np.nan
        ...
        # Extrair o tipo de unidade (1=dia, 2=mês, 3=ano)
    ...
    def _categorize_age_groups(self):
        ...
        # Usar a coluna IDADE_ANOS em vez de NU_IDADE_N
